...
import { ManagedPoolPriceImpact } from '../managed/priceImpact.concern';
...
export class ManagedPoolJoin implements JoinConcern {
  buildJoin = ({
    joiner,
    pool,
    tokensIn,
    ...
    const priceImpactConcern = new ManagedPoolPriceImpact();
